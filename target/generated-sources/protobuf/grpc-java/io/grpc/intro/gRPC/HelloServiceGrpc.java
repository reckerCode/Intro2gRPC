...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.grpc.intro.gRPC.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.grpc.intro.gRPC.HelloRequest,
      io.grpc.intro.gRPC.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = io.grpc.intro.gRPC.HelloRequest.class,
      responseType = io.grpc.intro.gRPC.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.intro.gRPC.HelloRequest,
      io.grpc.intro.gRPC.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<io.grpc.intro.gRPC.HelloRequest, io.grpc.intro.gRPC.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<io.grpc.intro.gRPC.HelloRequest, io.grpc.intro.gRPC.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.intro.gRPC.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.intro.gRPC.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(io.grpc.intro.gRPC.HelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.intro.gRPC.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.grpc.intro.gRPC.HelloRequest,
                io.grpc.intro.gRPC.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public io.grpc.intro.gRPC.HelloResponse hello(io.grpc.intro.gRPC.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.intro.gRPC.HelloResponse> hello(
        io.grpc.intro.gRPC.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((io.grpc.intro.gRPC.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.intro.gRPC.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.intro.gRPC.HelloServiceOuterClass.getDescriptor();
    }
